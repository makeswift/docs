...
Makeswift leverages [Next.js' Draft Dode](https://nextjs.org/docs/app/building-your-application/configuring/draft-mode) in the builder. This means you **do not** need a separate site for staging. All changes are versioned, and nothing will go into the live page until a publisher approves it.
