...
If you haven't upgraded to `0.13.0` please read the [migration guide](/migrations/0.13.0).
...
To replace these functions, please follow the [manual installation](/guides/manual-installation) guide.
