...
<Steps>
  <Step title="Navigate into a project folder or into the root directory for an existing project">
    ```bash
    cd example-project-folder
    ```
  </Step>
  <Step title="Perform the following command in the CLI">
    ```bash
    ...
    If you are working with an existing Next.js app, the CLI returns the following output. 
...
<Steps>
  <Step title="Select an existing site or create a new one">
    ![Select Site](./images/select-site.png)
  </Step>
  <Step title="Pick a template (optional)">
    ![Select Template](./images/select-template.png)
  </Step>
  <Step title="Check the CLI for prompts">
...
- You can make your own custom components available in Page Builder. To learn how, see [Registering Components](/essentials/components). For examples on how to register a component, navigate to the `components` folder in your local Next app.  
