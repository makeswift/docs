...
- The [`RichText`](/reference/controls/rich-text) control provides a `ReactNode` to your component, and then renders an inline rich text editor <Tooltip tip="Interactive elements placed on the Makeswift builder preview">overlay</Tooltip> wherever that `ReactNode` is rendered.
