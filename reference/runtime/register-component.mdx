...
<Info>
  This is just a naming convention, the filename and extension can be whatever makes sense to you.
</Info>
...
The file `makeswift/components.ts` should be imported wherever you use [`<ReactRuntimeProvider>`](/reference/components/react-runtime-provider) in your app.
