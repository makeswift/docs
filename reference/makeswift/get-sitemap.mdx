---
title: "getSitemap"
description: "A sitemap is a structured list of pages that enables web crawlers to find the pages of a site. `getSitemap` provides SEO information about the pages created within Makeswift. You can combine the results of `getSitemap` with SEO information for your hardcoded pages to create a sitemap."
---
...
<ParamField query="after" type="number" default={0}>
  Starting pagination position by index of the last sitemap entry fetched.
</ParamField>

<ParamField query="pathnamePrefix" type="string" default="/">
  [Pathname](https://developer.mozilla.org/en-US/Web/API/URL/pathname) prefix to
