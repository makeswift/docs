---
title: "getSitemap"
description: "A sitemap is a structured list of pages that enables web crawlers to find the pages of a site. `getSitemap` provides SEO information about the pages created within Makeswift.
