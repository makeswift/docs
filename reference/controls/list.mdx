...
This example adds a List control to the `accordionTitles` prop of an accordions component.
...
This example uses the [Shape](/reference/controls/shape) control to define the structure of the objects in the `accordions` array.
