---
title: List
description: Adds lists to components in the Makeswift builder to visually display an `array` prop. Each item in the list has a value defined using another control.
---
