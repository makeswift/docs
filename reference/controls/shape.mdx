...
<ParamField query="type" type="{ [key: string]: Control }" required>
  ...
  consist of any Makeswift control.
</ParamField>
...
This example adds a Shape control to the `type` field of a [List](/reference/controls/list) control for a feature grid component.
