---
title: Color
description: Adds a color picker panel in the Makeswift builder to visually edit an RGBA `string` prop.
icon: "palette"
---
...
<ParamField
  ...
  default="horizontal"
>
  Position for the color label in relation to the color picker within the panel.
</ParamField>
