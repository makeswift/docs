...
`ReactRuntime.registerComponent` function accepts a `type` to identify the component, a `label` to 
label it in the Makeswift builder, and `props` to define the [controls](/architecture#controls).
...
"Visuals".
=======
"Visuals". See the [Examples](#creating-sections) section for details.
>>>>>>> fd9df8b (docs: add components)
...
displayed.
=======
displayed. See the [Examples](#custom-icon) section for details.
>>>>>>> fd9df8b (docs: add components)
