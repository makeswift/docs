...
import Experimental from "/snippets/readiness-phases/experimental.mdx";
import Alpha from "/snippets/readiness-phases/alpha.mdx";
import Beta from "/snippets/readiness-phases/beta.mdx";
...
<Frame>
  <img
    src="/images/makeswift-settings-early-access.png"
