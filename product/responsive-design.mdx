...
<Frame>
  ![Splitting rows into columns](/images/builder/device-toggle4.gif)
</Frame>
...
<Frame>
  ![Splitting columns into rows](/images/builder/device-toggle5.gif)
</Frame>
...
<Frame>![Visibility property](/images/visbility-spark.gif)</Frame>
