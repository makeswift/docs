...
<Frame>![Default device sizes](public/images/builder/device-toggle1.png)</Frame>
...
<Frame>![Inheriting from base](public/images/builder/device-toggle2.png)</Frame>
...
<Frame>![Reset to desktop](public/images/builder/device-toggle3.png)</Frame>
