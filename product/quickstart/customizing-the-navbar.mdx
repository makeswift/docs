...
With the **Navbar** component selected, click **Edit component** in the Properties Sidebar to enter edit mode. You'll now see the properties associated with this global component. In the canvas, click on the nested Box component with the name **Navigation**. Here you can edit the links in the Navbar component.
