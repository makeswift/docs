...
Notice this section has two columns: one for the text and button on the left and one for an image on the right. This section uses nested Boxes to create this two-column layout. To better visualize this, hover over the heading text to display the [Breadcrumbs](/product/layouts#selecting-components).
