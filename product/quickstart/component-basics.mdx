...
Spend a few seconds exploring the Canvas and its components. You can click on any component in the Canvas to see its corresponding properties in the Properties Panels.
...
Notice that you've lost the green accent color in the text. Double-click again and select the text **Makeswift**. In the Properties Panel, under the **Text style** section, click the color picker. Then, choose the green accent color.
