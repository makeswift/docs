...
> "An account with this email already exists. In order to use One-Click Catalyst, you must connect BigCommerce as a login method in user settings."
...
Connect your BigCommerce account to your existing Makeswift account, and then re-attempt to deploy a One-Click Catalyst application. To connect your BigCommerce account to your Makeswift account, navigate to **Settings** -> **Login Methods**.

<Frame>
  <img
    src="/images/product/user-settings/login-methods/add-big-commerce.jpeg"
