...
Component names are displayed in [Breadcrumbs](/product/layouts#selecting-components) and the [Layers Panel](/product/builder-basics#layers-panel) making it easier to discern between different components.
