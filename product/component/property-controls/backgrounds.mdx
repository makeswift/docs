...
<Frame>![Background propery](/public/images/builder/backgrounds1.gif)</Frame>

## Colors

Colors can be set as a background fill. You can also layer translucent colors on top of background images to add overlays.

<Frame>![Background colors](public/images/builder/backgrounds2.gif)</Frame>
...
<Frame>![Background images](public/images/builder/backgrounds3.gif)</Frame>
...
<Frame>![Background Gradients](public/images/builder/backgrounds1.gif)</Frame>
...
<Frame>![Background Videos](public/images/builder/backgrounds1.gif)</Frame>
