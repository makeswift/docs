---
title: "Animations"
description: "Animations add dynamic movement to your pages, enhancing the user experience. You can apply animations to a box component and its direct child components."
icon: "sparkles"
---

Animations can be customized, and include controls for animation type, duration, delay, and stagger.
...
Animate box in will apply the selected animation type to the box component and any child components nested within it. 
