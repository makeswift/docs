...
title: "Redirects"
description:
icon: "turn-right" iconType: "solid"
---
...
![create a redirect
](public/images/redirects/create-redirect.gif)
...
<Note>
  301 Redirects will need to be configured directly in your codebase. To do this
  you will need to utilize a [custom host](/product/site/hosting#custom-host)
</Note>
