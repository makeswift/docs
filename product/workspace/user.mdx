...
description:
icon: "user" iconType: "solid"
---

## **Managing Users**

Users in a workspace have access to sites, files, and databases. Each user is assigned a role that determines their permissions within the workspace. User management is handled in your settings.
...
![inviting user
](public/images/workspace/invite-user.gif)

Invited users will receive an email with a link to accept the invite. They'll be redirected to Makeswift to finalize the process. If it's their first time using Makeswift, they'll need to create an account after clicking the invite link. Existing users must be logged in with the matching email address.

<Note> Warning: Considerations for Google Sign-In and SSO</Note>
...
![removing users
](public/images/workspace/remove-user.gif)

### **Profile**

In User Settings > Profile, you can edit your name as it appears in the builder for Multiplayer mode. You can also change your email address and reset your password.
