...
<Frame>
  ![An email addressed entered in the Send Invite field. The role dropdown selector is expanded showing roles for Guest, Editor, Publisher, and Author.](images/makeswift-settings-users-send-invite.png)
</Frame>
...
<Frame>
  ![A popup window confirming deletion of a user. The dropdown selector next to the user is expanded showing the option for Remove user.](images/makeswift-settings-remove-user.png)
</Frame>
