...
Guests have read-only access to view page content and layout as well as preview links. Additionally, guest users **do not** count against the workspace user limit. Check your plan for details on user limits.
