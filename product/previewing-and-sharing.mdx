...
Share Links are powered by Site Previews, which means anyone with these links can view the shared version of your site directly on your site's domain itself. This means that site previews can be viewed on any device, including phones and tablets.

You can generate shareable links and/or site previews for any of the following:
