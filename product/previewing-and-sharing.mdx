...
Makeswift allows you to preview and share different versions of your site for enhanced collaboration and feedback using Share Links and Site Previews.

**[Share Links](#share-links)** allow you to create shareable links to different site versions, which you can then send to your team members or stakeholders. Share Links are powered by **[Site Previews](#site-preview)**, which enable recipients to view the shared version of your site directly on your site's domain on any device, including phones and tablets.

**[Site Previews](#site-preview)** also allow you to preview your site directly on your own device without generating a shareable link.
...
Share Links allow you to create shareable links that give others access to specific versions of your site.  This means that a recipient of a share link will be able to view the entire site as it was in the shared version.
