...
To preview via the **View page** icon, click the icon to the right of the address bar in the Visual Builder header. This opens your site in a new tab and shows the current draft state.
