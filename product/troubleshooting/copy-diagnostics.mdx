...
<img
  ...
  src="/images/product/troubleshooting/copy-diagnostics-button.png"
  alt="Copy diagnostics button location in the Makeswift Visual Builder interface"
/>
<img
...
<Note>
  The Copy Diagnostics button is located in the bottom-left corner of the builder interface, accessible through the help menu alongside other support options.
</Note>
...
- **Custom Host Status**: Whether you're using a custom host or Makeswift's default hosting
...
- Only technical identifiers and configuration information is captured
