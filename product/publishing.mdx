...
Toggle the checkbox to the left of each item to include it in this publish. You can also toggle the checkbox found in each section's header to toggle all of its items on or off.
