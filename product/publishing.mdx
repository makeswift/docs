...
The Preview button by the URL bar will allow you to see a preview of what you have on your page without having the need to publish it. It’s similar to being in Interact mode but in it’s own window so that you can preview your page properly before publishing it live.
...
![Publish button](public/images/builder/publishing1.png)
...
![Selective publish dialogue](public/images/builder/publishing2.png)
...
![Online toggle](public/images/builder/publishing3.png)
...
![Publishing site resources](public/images/builder/publishing4.png)
...
<Note>
Site versions are currently only available to Enterprise customers.
...
![Publish history](public/images/builder/publishing5.png)
