...
<Note>
  ...
  workspace. For read-only access, you can add users with the role of `Guest`
  which don't count against the number of user seats in your plan. For more
  information, see the [Users](/product/workspace/users) page.
</Note>
