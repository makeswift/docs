...
<Warning>
  Scheduled publishes are currently only available on paid plans. Refer to the
  [Plans](/product/workspace/plans) page for full details.
</Warning>

In addition to publishing changes immediately, you have the ability to schedule publishes in the future. Here are a couple of important things to understand:

- Scheduled changes won't show up in the the **Changes** tab while they are scheduled
- You can cancel a scheduled publish at any time
