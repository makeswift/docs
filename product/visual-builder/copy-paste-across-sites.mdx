...
The Visual Builder does not support copying and pasting tables across sites. If you attempt to paste a table from a different site, the only option available will be to clear the table from the selection.