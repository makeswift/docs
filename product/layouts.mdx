...
If you have a lot of nested content on your page, it can be difficult to find and click on a specific component. Breadcrumbs are designed to help you understand your page structure and make it easier to select and move your Boxes. To get to the breadcrumbs, hover over a component within the desired Box. Move your cursor to the label found at the top left of the component and it's breadcrumbs will open.
...
In addition to Breadcrumbs, you can use the [Layers Panel](/product/builder-basics#layers-panel) to easily view and select individual components from your page.
