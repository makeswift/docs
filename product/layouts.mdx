---
title: 'Layouts'
description: 'Layouts are building blocks used to compose pages and are most commonly created using the Box component. The Makeswift builder gives you controls to organize and navigate layouts easily.'
icon: 'table-layout'
---

## Creating a layout using a Box

You can create a new layout by clicking the [Box](/product/components#box) component in the toolbar and dragging it onto your page. You can add any number of [Components](/product/components) into a Box, including other Boxes. Components can be placed side-by-side to create columns or placed above and below to create new rows.

> Shortcut: Use `x` to select the Box tool. Then, click on the page where you want to add it.

<Frame>![Creating layouts with boxes](/images/builder/layouts1.gif)</Frame>

When creating a multi-column layout, where each column has multiple elements, you’ll most likely want to wrap each column in a Box. This way you can sort columns easily and keep all the elements together when creating [breakpoints](/product/responsive-design) for mobile devices.
...
You can also click and hold a breadcrumb to drag and drop the highlighted box somewhere else.
