...
Layout refers to the composition of your page. Pages are in and of themselves components containing other components. The Makeswift Builder gives you some controls to prganize and navigate layouts easily
...
![Creating layouts with boxes](public/images/builder/layouts1.gif)
...
<Tabs>
  <Tab title="Width">
Similarly to [Image](/product/toolbar/image) you can set a maximum [Width](/product/component/property-controls/width) to a box or element to maintain consistent spacing between sections. You can either set a pixel value, or a percentage of the screen. Keep in mind [Device Toggle](/product/canvas/device-toggle) when managing width across devices.
</Tab>
  <Tab title="Grid">
Boxes are divided into a 12 column grid, allowing you to shift the proportions of the contents in the box by 1/12th at a time per row. To adjust, simply click and hold the dotted column line and drag.

![12 column grid](public/images/builder/Overlays.gif)

</Tab>
  <Tab title="Margin">
[Margin](/product/component/property-controls/margin) is the space between elements. With an element selected, drag the top or bottom handles to change its margin. For a box, they will be the top-most and bottom-most handle
...
![Padding and margin control shortcut](public/images/builder/Overlays6.gif)
  ...
  <Tab title="Padding">
[Padding](product/component/property-controls/padding.mdx) is the space created between a box's border and its contents. This differs from margin which is used to push elements away from each other.
