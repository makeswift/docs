...
For more advanced use cases, though, you can integrate Makeswift into a [Next.js](https://nextjs.org/) project that you deploy and host yourself. This is referred to as a [custom host](/product/site/hosting#custom-host). By doing this, you can create custom components, integrate data sources, and have full control over your hosting.
