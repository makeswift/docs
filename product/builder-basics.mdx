...
Allows you to drag and drop components onto the canvas to become elemnts. Once on the canvas, stay in Build mode to drag your elements around, as well as select the elements to edit its properties. The majority of your creation sessions will happen in Build mode.

### Interact

Renders the canvas similarly to how your components will react on your live domain. You can use Interaction mode to engage with any interactive element (e.g. buttons, links, etc.) to see its behavior without utilizing [Publlishing](/product/publishing) or [Preview links](/product/publishing#previewing) and leaving the Makeswift Builder. You may also need to use Interaction mode to expose an editable section of an element, like an accordion for instance.

<Frame>
  ![Visual builder showing interaction mode for accordion
  component](/images/builder/interact-mode.gif)
</Frame>
