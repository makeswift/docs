...
You can copy and paste elements within the same site or between different sites. This is useful for reusing elements or layouts without having to recreate them from scratch. 
...
See our Cross-site Copy & Paste guide for more information.
