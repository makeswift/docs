...
```
  ...
  <Step title="Update the root layout">
    In your root layout, wrap your app with the `MakeswiftProviders` component created in the last step, import the registered components, and add the `DraftModeScript` to the `head`. 
...
Create an [optional catch-all route](https://nextjs.org/docs/app/building-your-application/routing/dynamic-routes) named `[[...path]]`. 
