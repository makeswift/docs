...
1. Install dependencies to match the current branch

Ensure your local environment has the correct and updated dependencies for the specific branch you're working on by running the following command:

```
pnpm i
```

This will install and synchronize the necessary dependencies based on the package.json and pnpm-lock.yaml files for the current branch.
Ensure that your local environment has the correct and updated dependencies required for the specific branch you are working on by installing pnpm.

2. Start the development server

Once the dependencies are installed, you can start the development server to run the project locally. Use the following command:
...
Within the Makeswift Site Settings, update your host to whatever port your local development is running on. Typically it should run on `http://localhost:3000`
