...
<Check>
  All Makeswift plans support some level of localization. To follow this guide,
  you'll need a plan that supports multiple locales, which is available with all
  of our paid plans. Please check your current [plan](/product/workspace/plans)
  for full details and upgrade options.
</Check>
...
![Makeswift dashboard showing the root settings page for Locales](/images/localization-first-step.png)
