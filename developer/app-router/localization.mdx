...
Remember that localized content (pages, components, etc.) need to be published just like any other resource. After you're done making all of your changes, publish them for these changes to go live.
