...
You can also localize a visually created component. To do this, select the component, then click **Edit component** within a localized page. Make your changes, and then click **Save**. That component will be saved for that locale and will not effect the component for the base locale.
...
Remember that localized content (pages, components, etc.) need to be published just like any other resource. After you're done making all of your changes, publish them for these changes to go live. In the publish dialog, you'll be able to see the locale attached to each resource.
