...
Create a `middleware.ts` file at the same level as your `pages` directory. The
`withMakeswiftMiddleware` adds middleware to your project to show you the preview
