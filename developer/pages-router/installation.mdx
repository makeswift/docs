...
Create the file `src/pages/_document.tsx` and export `Document` from `@makeswift/runtime/next/document`:

<DocumentExample />

If you already have a `_document.tsx`, you can extend the `Document` from `@makeswift/runtime/next/document` instead.
