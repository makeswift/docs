...
1. If you already have a root page file (`index.tsx`), delete it to ensure that all pages (including the home page) are managed by Makeswift.
...
<CardGroup cols={3}>
  <Card title="Concepts" href="/developer/concepts">
    Learn core concepts about how Makeswift works.
  </Card>
  <Card
    title="Custom components"
    href="/developer/guides/how-to/built-in-components"
  >
    Build custom components to be used in the Visual Builder.
  </Card>
