...
After completing this setup, you can now start to add localized content in the Visual Builder.
...
**Note that until you decide to edit and publish this localized page, it will continue to serve the page for the default locale.** After choosing to edit the localized page, content changes are only associated with this locale and do not affect the base locale.
