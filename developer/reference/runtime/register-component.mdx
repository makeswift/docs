...
2. <ParamField query="options" type="object" required>
     ...
     <Expandable>
       ...
       <ParamField query="description" type = "string">
          The description shown in the Makeswift Builder. This is written in Markdown format.
       </ParamField>
...
<Note>You can view the supported markdown items `here`.</Note>

In the builder
component tray and panel, we can see our description with the selected icon.

<Frame>
  <img
    src="/images/register-custom-description1.png"
    alt="Screenshot of first registered component description"
  />
</Frame>
