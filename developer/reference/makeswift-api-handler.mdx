     ...
     <Expandable>
       ...
       <ParamField query="events" type="object">
        ...
        <ParamField query="events.onPublish" type="() => void | Promise<void>">
          ...
          #### Local development
          The `onPublish` will not work when running on `localhost`. To test locally, you can setup a reverse proxy using a service like [`ngrok`](https://ngrok.com/docs/what-is-ngrok/).
