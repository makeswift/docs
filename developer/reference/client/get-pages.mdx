...
router, use the [`getSiteVersion` method](/reference/client/get-site-version) to
...
locales](/app-router/localization), you can pass the `locale` option to the
...
here](/app-router/localization#getting-started).
